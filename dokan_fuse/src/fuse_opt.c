...
static int process_opt(struct fuse_opt_context *ctx, const struct fuse_opt *opt,
                       size_t sep, const char *arg, int iso) {
...
static int process_gopt(struct fuse_opt_context *ctx, const char *arg,
                        int iso) {
  size_t sep;
...
static int process_option_group(struct fuse_opt_context *ctx,
                                const char *opts) {
  int res;
  char *copy;
